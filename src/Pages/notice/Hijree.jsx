              ...
              <div className="pb-3 card event_card event_card_details">
                ...
                <div className="card-body p-4 mt-4">
                  ...
                  <p>
                    ...
                    <font face="Poppins, sans-serif">সনের&nbsp;</font>
                    <font
                ...
                <Link to="#">
                  <img
                    ...
                    src="../public/storage/notice/1445-hijree-trriteey-srenir-preekshar-rutin.jpg"
                    alt="Card image cap"
                  />
                </Link>
                <br />
                <Link
                  to="../public/storage/notice/1445-hijree-trriteey-srenir-preekshar-rutin.jpg"
                ...
                <object
                  data="https://nooraniboardctg.com/public/storage/notice/1443-hijree-trriteey-srenir-preekshar-rutin_pdf.pdf"
              ...
              <div className="card">
                ...
                <div className="card-body p-0">
                  <ul className="list-group event_list">
                    ...
                    <Link
                      to="/notice/2023-saler-ple-narsaree-prthm-oo-dwiteey-srenir-preekshar-rutin"
                      className="shadow-sm list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                    >
                      <div className="ribbon-wrapper">
                        <div className="notice_ribbon">28th Oct-23</div>
                      </div>
                      <div className="title d-inline-block notice_title_link">
