          ...
          <div className="row">
            <div className="col-md-8">
              <div className="pb-3 card event_card event_card_details">
                ...
                <object
                  data="https://nooraniboardctg.com/public/storage/notice/kendreey-snd-preeksha-2023-er-cithi_pdf.pdf"
                ...
                >
                  <p>
                    Click here to view{" "}
                    <Link to="./public/storage/notice/kendreey-snd-preeksha-2023-er-cithi_pdf.pdf">
                      PDF File !
                    </Link>
                  </p>
                </object>
