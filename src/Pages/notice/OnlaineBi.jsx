            ...
            <div className="col-md-8">
              <div className="pb-3 card event_card event_card_details">
                ...
                <div className="card-body p-4 mt-4">
                  ...
                  <p>
                    অনলাইনে কিভাবে বই ও ষ্টেশনারী পণ্য ক্রয় করতে হয় সেটির পদ্ধতি
                    ধাপে ধাপে ছবি আকারে বুজিয়ে দেওয়া হল
                    <br />
                  </p>
                  <p />
                </div>
                <object
                  data="https://nooraniboardctg.com/public/storage/notice/onlaine-bi-oo-shtesnaree-pnz-kryer-pddhti_pdf.pdf"
                ...
                >
                  <p>
                    Click here to view{" "}
                    <Link to="./public/storage/notice/onlaine-bi-oo-shtesnaree-pnz-kryer-pddhti_pdf.pdf">
                      PDF File !
                    </Link>
                  </p>
                </object>
