          ...
          <div className="row">
            <div className="col-md-8">
              <div className="card event_card event_card_details">
                ...
                <object
                  data="https://nooraniboardctg.com/public/storage/forms/muyallim-snd-abedn-frm-bangla_pdf.pdf"
                ...
                >
                  <p>
                    Click here to view{" "}
                    <Link to="./public/storage/forms/muyallim-snd-abedn-frm-bangla_pdf.pdf">
                      PDF File !
                    </Link>
                  </p>
                </object>
