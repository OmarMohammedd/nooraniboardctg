            ...
            <div className="col-md-8">
              <div className="card event_card event_card_details">
                <div className="card-body p-4 mt-4">
                  ...
                  <object
                    data="https://nooraniboardctg.com/public/storage/academic/narsaree-sudhu-2021-siksha-brsher-jnz-przojz_pdf.pdf"
                  ...
                  >
                    <p>
                      Click here to view{" "}
                      <a href="/public/storage/academic/narsaree-sudhu-2021-siksha-brsher-jnz-przojz_pdf.pdf">
                        PDF File !
                      </a>
                    </p>
                  </object>
