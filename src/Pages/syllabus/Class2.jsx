                ...
                <div className="card-body p-4 mt-4">
                  <h5 className="card-title text-center">
                    <Link className="text-center" to="#">
                      দ্বিতীয় শ্রেণি-এর সিলেবাস
                    </Link>
                  </h5>
                  <object
                    data="https://nooraniboardctg.com/public/storage/academic/dwiteey-sreni-sudhu-2021-siksha-brsher-jnz-przojz_pdf.pdf"
                  ...
                  >
                    <p>
                      Click here to view{" "}
                      <a href="/public/storage/academic/dwiteey-sreni-sudhu-2021-siksha-brsher-jnz-przojz_pdf.pdf">
                        PDF File !
                      </a>
                    </p>
                  </object>
            ...
            <div className="col-md-4">
              <div className="card">
                <h5 className="card-header custom_header">
                  <i className="fas fa-book-open" /> অন্যান্য শ্রেণী-সমূহের
                  সিলেবাস
                </h5>
